...
/*   Updated: 2024/01/25 23:10:02 by sbalk            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	calculate_ray_dir(t_ray *ray, int i)
{
	double	camera_x;

	camera_x = 2 * i / (double)ray->win_size->x - 1;
	ray->dir.x = ray->player_dir->x + ray->plane->x * camera_x;
	ray->dir.y = ray->player_dir->y + ray->plane->y * camera_x;
}
